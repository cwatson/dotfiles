...
" Highlight HTML code if it has a pub title
syn keyword     mailClass   citation_title contained
syn match      mailHtml    contains=mailClass "<div.*authorlist"
...
hi def link mailClass           Special
hi def link mailHtml            Special
